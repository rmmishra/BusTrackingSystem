...
<div id="bg3">
	<div id="bg4">
		...
		<div><center> <h1>Bus Drivers Updation Form</h1><table border="1">
...
try{
	...
	if(rs.next()){
		...
		%>
		<tr><td >Driver Id</td><td width="5"><input type="text" readonly="true" name="txtid" value="<%=rs.getString(1) %>"></input></td></tr>
		...
		<tr><td align="center"><input type="submit" value="Update" onclick="updatedata.jsp"></input></td>
