...
try{
    ...
    ResultSet rs=st.executeQuery("select * from driver_info where resign='N'");
	while(rs.next()){
		...
		<td><a href="update.jsp?ch=5&dno=<%=rs.getString(1) %>"> Edit </a><a href="delete_driver.jsp?ch=5&dno=<%=rs.getString(1) %>"> delete </a></td>
		</tr>
